    ...
    <footer class="footer footer-center p-16 bg-gray-800 text-white text-base-content rounded">
      ...
      <div className=" flex flex-col lg:flex-row ">
        <div class="grid grid-flow-col gap-4 text-white">
          <span className="  text-2xl">naimur202163@gmail.com || </span>
        </div>

        <div>
          <div class="grid grid-flow-col gap-4">
            <a href="https://www.facebook.com/nainur202163">
              <p className="icon text-white text-4xl">
                <AiOutlineFacebook></AiOutlineFacebook>
              </p>
            </a>
            <a href="https://www.linkedin.com/in/md-naimur-rahman-76aaa3216/">
              <p className="icon text-white text-4xl">
                <AiFillLinkedin></AiFillLinkedin>
              </p>
            </a>
            <a href="https://github.com/naimur202163">
              <p className="icon text-white text-4xl">
